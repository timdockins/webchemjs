...
function query(params, callback) {
    ...
    if ( !Array.isArray(options.compounds) ) {
        ...
        if (!callback) {
            return retrieve( options.compounds.id, options.representaiton, options.compounds.resolver, options.first, options.verbose);
        } else {
            retrieve( options.compounds.id, options.representaiton, options.compounds.resolver, options.first, options.verbose)
                .then(
                    function(values) {
