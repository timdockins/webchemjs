...
var NDFRT = {
    findConceptsById : queryFactory( "Ndfrt/id" ),
    findConceptsByName : queryFactory( "Ndfrt/search" ),
    getEPCClassOfConcept : queryFactory( "Ndfrt/EPCC" )
};
...
function queryFactory ( postfix ) {
    return function( options, callback) {
        ...
        var url = [base, postfix].join('/') + '?' + queryString.stringify( query );
